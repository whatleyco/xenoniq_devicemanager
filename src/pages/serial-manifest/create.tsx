...
export const SerialManifestCreate: React.FC<IResourceComponentsProps> = () => {
  ...
  React.useEffect(() => {
    if (skuValue !== currentSku) {
      ...
      // Clear serial field when SKU changes to avoid validation conflicts
      formProps.form?.setFieldValue('serial', '');
    }
  }, [skuValue, currentSku, formProps.form]);
